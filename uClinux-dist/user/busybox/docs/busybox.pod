...
modprobe modprobe	 [  B<-adnqv>  ] [ B<-C> config ] module [ symbol=value ... ]
modprobe [ B<-adnqv> ] [ B<-C> config ] [ B<-t> type ] pattern
modprobe B<-l> [ B<-C> config ] [ B<-t> type ] pattern
modprobe B<-c> [ B<-C> config ]
modprobe B<-r> [ B<-dnv> ] [ B<-C> config ] [ module ...]
modprobe B<-V>
